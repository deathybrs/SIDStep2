...
PulseTableRow::PulseTableRow ()
{
    ...
    cachedImage_pulseTableRow_png_1 = juce::ImageCache::getFromMemory (
                                                                       pulseTableRow_png
            ...
            )
{
    ...
    if ( labelThatHasChanged == pulseCycle . get () )
    {
...
auto
    PulseTableRow::Get () const -> unsigned
{
    return static_cast < unsigned > ( pulseCycle -> getText () . getIntValue () );
}
